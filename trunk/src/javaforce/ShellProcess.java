...
public class ShellProcess {
   ...
   * responses must cause the process to terminate. If a "Password:" is prompted
   * for, the user will be prompted for the password.
   */
  ...
  /**
   * Runs a process, sending responses to stdin and returning all stdout. The
   * responses should cause the process to terminate. jsudo-ask is used if the
   * command is sudo. If redirStderr is true then stderr will be redir to
   * stdout.
   */
