...
//      SSLSocketFactory sslsocketfactory = (SSLSocketFactory) SSLSocketFactory.getDefault();  //this method will only work with trusted certs
  ...
  public void get(File filename, File out) throws Exception {
    getPort();
    cmd("retr " + filename.getName());
  ...
  public void get(File filename, OutputStream os) throws Exception {
    getPort();
    cmd("retr " + filename.getName());
    getData(os);
    getResponse();
  ...
  public void put(InputStream is, File filename) throws Exception {
    getPort();
    cmd("stor " + filename.getName());
    putData(is);
    getResponse();
  }

  public void put(File in, File filename) throws Exception {
    getPort();
    cmd("stor " + filename.getName());
